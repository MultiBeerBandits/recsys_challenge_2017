...
from src.SLIM_BPR.Similarity_Matrix_Recommender import Similarity_Matrix_Recommender
from scipy.special import expit

from src.SLIM_BPR.BPR_Sampling import BPR_Sampling
from src.SLIM_BPR.Recommender import Recommender
...
class SLIM_BPR_Python(BPR_Sampling, Similarity_Matrix_Recommender, Recommender):
    ...
    def __init__(self, URM_train, positive_threshold=3, sparse_weights = False):
        ...
        self.URM_mask.data = self.URM_mask.data # useless >= self.positive_threshold
